...
class Birthday1001:
    ...
    def calc_days_to_birthday(self):
        ...
        #birthday = datetime.date( 2009, 10, 1 ) 
    ...
    def birthday_today(self) :
        ...
        while not self.sleepEvent.is_set():
            ...
            self.matrix.draw_text( (67,32), "Chloe!!!", font=self.font.medium, fill=(150,150,150) ) 
    ...
    def birthday_countdown(self) :
        ...
        while not self.sleepEvent.is_set():
            ...
            self.matrix.draw_text( (67,17), "Chloe", font=self.font.medium, fill=(150,150,150) ) 
