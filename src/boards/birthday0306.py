...
class Birthday0306:
    ...
    def birthday_month(self) :
        ...
        while not self.sleepEvent.is_set():
            self.matrix.clear()
            self.matrix.draw_rectangle((0,0),(128,64),(0,0,0))
            ...
            self.matrix.draw_text( (67,32), "days old!", font=self.font.medium, fill=(150,150,150) ) 
            i += sleep_rate
            self.matrix.image.save("/home/pi/pbjelly/birthday0306.png")
            self.matrix.render()
